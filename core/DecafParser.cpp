  ...
  try {
    ...
    if(recursive_lookup<Symbol>(table_top, [&](shared_ptr<SymbolTable> t){return t->symbols();}, [&](Symbol &s){return s.name() == (dynamic_cast<LocationContext *>(_localctx)->idToken != nullptr ? dynamic_cast<LocationContext *>(_localctx)->idToken->getText() : "");}, parent_table, &_localctx->out)){
      ...
      if(_localctx->array_check){
        Type type_info;
        recursive_lookup<Type>(table_top, [&](shared_ptr<SymbolTable> t){return t->types();}, [&](Type &t){return t.name() == _localctx->out.type();}, &type_info);
        if(type_info.size() == _localctx->out.size()){
...
void DecafParser::ExpressionContext::copyFrom(ExpressionContext *ctx) {
  ...
  this->next_instr = ctx->next_instr;
}
        ...
        case 4: {
          ...
          dynamic_cast<EqExprContext *>(_localctx)->rexpr = dynamic_cast<EqExprContext *>(_localctx)->expressionContext = expression(4);
                    ...
                    if(dynamic_cast<EqExprContext *>(_localctx)->lexpr->d_type != dynamic_cast<EqExprContext *>(_localctx)->rexpr->d_type){
                      ...
                      e_handler->get_lambda(CAN_NOT_USER_OPERATOR, (dynamic_cast<EqExprContext *>(_localctx)->lexpr != nullptr ? (dynamic_cast<EqExprContext *>(_localctx)->lexpr->start) : nullptr)->getLine(), (dynamic_cast<EqExprContext *>(_localctx)->lexpr != nullptr ? (dynamic_cast<EqExprContext *>(_localctx)->lexpr->start) : nullptr)->getCharPositionInLine(), vector<string>{dynamic_cast<EqExprContext *>(_localctx)->lexpr->d_type})();
                    }else if(find(valid_types.begin(), valid_types.end(), dynamic_cast<EqExprContext *>(_localctx)->rexpr->d_type) == valid_types.end()){
                      e_handler->get_lambda(CAN_NOT_USER_OPERATOR, (dynamic_cast<EqExprContext *>(_localctx)->rexpr != nullptr ? (dynamic_cast<EqExprContext *>(_localctx)->rexpr->start) : nullptr)->getLine(), (dynamic_cast<EqExprContext *>(_localctx)->rexpr != nullptr ? (dynamic_cast<EqExprContext *>(_localctx)->rexpr->start) : nullptr)->getCharPositionInLine(), vector<string>{dynamic_cast<EqExprContext *>(_localctx)->rexpr->d_type})();
                    }
...
DecafParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x2, 0xe8, 0xe9, 0x8, 0xe, 0x1, 0x2, 0xe9, 0xea, 0x5, 0x2c, 0x17, 0x2, 
    0xea, 0xeb, 0x8, 0xe, 0x1, 0x2, 0xeb, 0x100, 0x3, 0x2, 0x2, 0x2, 0xec, 
    0xed, 0x5, 0x1c, 0xf, 0x2, 0xed, 0xee, 0x8, 0xe, 0x1, 0x2, 0xee, 0x100, 
    0x3, 0x2, 0x2, 0x2, 0xef, 0xf0, 0x5, 0x18, 0xd, 0x2, 0xf0, 0xf1, 0x8, 
    0xe, 0x1, 0x2, 0xf1, 0x100, 0x3, 0x2, 0x2, 0x2, 0xf2, 0xf3, 0x7, 0xf, 
    0x2, 0x2, 0xf3, 0xf4, 0x5, 0x1a, 0xe, 0x2, 0xf4, 0xf5, 0x7, 0x11, 0x2, 
    ...
    0x2, 0x2, 0xff, 0xec, 0x3, 0x2, 0x2, 0x2, 0xff, 0xef, 0x3, 0x2, 0x2, 
    0x2, 0xff, 0xf2, 0x3, 0x2, 0x2, 0x2, 0xff, 0xf7, 0x3, 0x2, 0x2, 0x2, 
